...
function check_answer() {
  ...
  {
    if (document.getElementById("two-one").value == 'D' && document.getElementById("two-two").value == 'O' && document.getElementById("two-three").value == 'O' && document.getElementById("two-three").value == 'R')
    {
